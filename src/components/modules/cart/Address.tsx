...
import { citySelector, shippingAddressSelector, updateCity, updateShippingAddress } from "@/redux/featurs/cartSlice";
  ...
  return (
    <div className="border-2 border-white bg-background brightness-105 rounded-md col-span-4  p-5 ">
      <div className="flex flex-col justify-between h-full">
        ...
        <div className="mt-5">
          <Select value={selectCity || ""} onValueChange={(city) => handleCitySelect(city)}>
